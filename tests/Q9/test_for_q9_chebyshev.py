...
from src.Q9.weighted_chebyshev.repeated_astar_for_q9_weighted_chebyshev import repeated_forward_astar_weighted
from src.Q9.weighted_chebyshev.repeated_astar_for_q9_chebyshev import repeated_forward_astar_chebyshev
import numpy as np
...
for p in Prob:
    ...
    for x in range(0, iterations_per_prob):
        maze = create_maze(dim)
        set_attr_euclidean(maze, dim, p)
        new_path_from_repeated_forward_astar, cells_processed = repeated_forward_astar_chebyshev(maze, dim, 0, 0)
