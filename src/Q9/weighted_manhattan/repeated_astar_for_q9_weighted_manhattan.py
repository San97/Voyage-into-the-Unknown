...
from src.Q9.weighted_manhattan.set_attr_new_maze_weighted_manhattan import set_attr_weighted_manhattan
from src.AStar import astar


def repeated_forward_astar_weighted(MAZE, DIM, x, y):
    """
    This is the function of Repeated A* with weighted manhattan as heuristic.The whole working is same as
    ...
    set_attr_weighted_manhattan(new_maze, dim1)
    new_path = list()

    path, blocked_cell, nodes_traversed = astar(new_maze, dim1, i, j)
