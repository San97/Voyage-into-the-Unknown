...
from src.Q9.weighted_manhattan.set_attr_new_maze_manhattan import set_attr_new_maze_manhattan
from src.AStar import astar


def repeated_forward_astar_manhattan(MAZE, DIM, x, y):
    """
    This is the function of Repeated A* with manhattan as heuristic.The whole working is same as
    ...
    set_attr_new_maze_manhattan(new_maze, dim1)
    new_path = list()
