...
from src.Q9.weighted_chebyshev.set_attr_new_maze_chebyshev import set_attr_new_maze_chebyshev
from src.AStar import astar


def repeated_forward_astar_chebyshev(MAZE, DIM, x, y):
    """
    This is the function of Repeated A* with chebyshev as heuristics. The whole working is same as RepeatedA*.py file.
    Only heuristics is changed.
    ...
    set_attr_new_maze_chebyshev(new_maze, dim1)
    new_path = list()
