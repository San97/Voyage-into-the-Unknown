...
from helper.for_new_maze.heuristics.generate_chebyshev_for_new_maze import cal_chebyshev_for_new_maze
from src.constants import INF


def set_attr_new_maze_chebyshev(Maze, Dim):
    maze = Maze
    dim = Dim
    ...
    for i in range(0, dim):
        for j in range(0, dim):
            if (i == 0) and (j == 0):
                ...
                maze[i][j].hn = cal_chebyshev_for_new_maze(i, j, dim)
