...
from src.Q9.weighted_euclidean.set_attr_new_maze_weighted_euclidean import set_attr_weighted_euclidean
from src.AStar import astar


def repeated_forward_astar_weighted(MAZE, DIM, x, y):
    """
    This is the function of Repeated A* with weighted euclidean as heuristic.
    ...
    set_attr_weighted_euclidean(new_maze, dim1)
    new_path = list()
